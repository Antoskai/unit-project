...
def play_guessing_game():
    print("hello welcome to thee guessing game!")
    print("Think of a number between the range of your choice, and I will try to guess it.")
